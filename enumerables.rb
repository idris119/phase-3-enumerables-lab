...
def get_names(spicy_foods)
  # your code here
  spicy_foods.map{ |foody| foody[:name]}
end
...
def spiciest_foods(spicy_foods)
  # your code here
  spicy_foods.select{ |heaty| heaty[:heat_level]> 5}
end
...
def print_spiciest_foods(spicy_foods)
  # your code here
  high_heat_foods = spicy_foods.select { |food| food[:heat_level] > 5 }
  print_spicy_foods(high_heat_foods)
end
